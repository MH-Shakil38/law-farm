                                    ...
                                    <div class="d-flex align-items-center position-relative ">
                                        ...
                                        <div class="flex-1 ms-3">
                                            ...
                                            <p class="text-500 fs-11 mb-0">
                                                {{ $info->user_type == 1 ? 'Admin' : ($info->user_type == 2 ? 'Employee' : 'Lawyer') }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col py-1">
                                <div class="row flex-end-center g-0">
                                    ...
                                    <div class="col-5 pe-x1 ps-2">
                                        <div class="fs-10 fw-semi-bold">
                                            <span class=""
                                                style="font-size: 9px">{{ \Carbon\Carbon::parse($info->last_logedin)->format('d M, h:m A') }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6 pe-x1 ps-2">
                                        <div class="fs-10 fw-semi-bold">
                                            <span class=""
                                                style="font-size: 9px">{{ $info->last_activity ? \Carbon\Carbon::parse($info->last_activity)->format('d M, h:m:s A') : 'NULL' }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="col-lg-6 pe-lg-2 mb-3">
    <div class="card h-lg-100 overflow-hidden">
        ...
        <div class="card-body p-0">
            <div class="card-body p-0">
                <div
                    class="border-bottom row g-0 align-items-center py-2 position-relative border-bottom border-200">
                    <div class="col ps-x1 py-1 position-static">
                        <div class="d-flex align-items-center">
                            <div class="d-flex align-items-center position-relative ">
                        ...
                        <div class="col ps-x1 py-1 position-static">
                            <div class="d-flex align-items-center">
                                <div class="d-flex align-items-center position-relative ">
                                    ...
                                    <div class="flex-1 ms-3">
                                        <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900"
                                                href="{{ route('clients.show', $info->id) }}">{{ $info->name }}</a>
                                        </h6>
                                        <p class="text-500 fs-11 mb-0"> <b>Handle By:
                                            </b>{{ $info->lawyer->name }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col py-1">
                            <div class="row flex-end-center g-0">
                                <div class="col-6 pe-x1 ps-2">
                                    <div class="fs-10 fw-semi-bold">
                                        <span class=""
                                            style="font-size: 11px">{{ $info->case_number }}</span>
                                    </div>
                                </div>
                                <div class="col-6 pe-x1 ps-2">
                                    <div class="fs-10 fw-semi-bold">
                                        <span class=""
                                            style="font-size: 11px">{{ \Carbon\Carbon::parse($info->hearing_time)->format('d M, h:m A') }}
                                    </div>
                                </div>
