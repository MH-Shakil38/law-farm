        ...
        <table class="table w-100 mt-3">
            <thead>
                <tr style="height: 20px;">
                    <th class="col-2" style="padding: 0px;margin:0px">Date</th>
                    <th class="col-2" style="padding: 0px;margin:0px">Accunts</th>
                    <th class="col-2" colspan="2" style="padding: 0px;margin:0px">Description</th>
            ...
            <tbody>
                ...
                @for ($i = 0; $i < 15 - $client->invoices->count(); $i++)
                    @if ($i == 4)
                    <tr style="height: 10px; background: {{ $i % 2 == 0 ? '' : '#fdf6e7' }} !important;">
                        <td class="col-2"
                            style="padding: 0px;background: {{ $i % 2 == 0 ? '' : '#fff5f5' }};border:none"><strong>  {{ Carbon\Carbon::parse($invoice->created_at)->format('d M y') }} </strong></td>
                            <td class="col-2"
                            style="padding: 0px;background: {{ $i % 2 == 0 ? '' : '#fff5f5' }};border:none">&nbsp;</td>
                            <td class="col-2" colspan="3"
                            style="padding: 0px;background: {{ $i % 2 == 0 ? '' : '#fff5f5' }};border:none">{{ strip_tags($invoice->note) }}</td>
                        <td class="col-2"
                            style="padding: 0px;background: {{ $i % 2 == 0 ? '' : '#fff5f5' }};border:none">&nbsp;</td>
                        <td class="col-2"
                            style="padding: 0px;background: {{ $i % 2 == 0 ? '' : '#fff5f5' }};border:none">&nbsp;</td>
                        ...
                        <td class="col-2" style="padding: 0px;background:#eaeaea">
                            <span style="float:left;margin-left:10px">$</span> <strong>{{ $invoice->amount }}  </strong> <span
                                style="float:right;margin-right:10px">-</span>
                        </td>
                    </tr>
                    @elseif ($i == 0)
                    @forelse ($client->invoices->slice(0, -1) as $invoice)
                    <tr style="height: 10px; background: {{ $loop->iteration % 2 == 0 ? '' : '#fdf6e7' }} !important;">
                        <td class="col-2"
                            style="padding: 0px;background: {{ $loop->iteration % 2 == 0 ? '' : '#fff5f5' }};border:none"><strong>  {{ Carbon\Carbon::parse($invoice->created_at)->format('d M y') }} </strong></td>
                            <td class="col-2"
                            style="padding: 0px;background: {{ $loop->iteration % 2 == 0 ? '' : '#fff5f5' }};border:none">&nbsp;</td>
                            <td class="col-2" colspan="3"
                            style="padding: 0px;background: {{ $loop->iteration % 2 == 0 ? '' : '#fff5f5' }};border:none;text-align:left;padding-left:20px">Previwes</td>
                        <td class="col-2"
                            style="padding: 0px;background: {{ $loop->iteration % 2 == 0 ? '' : '#fff5f5' }};border:none">&nbsp;</td>
                        <td class="col-2"
                            style="padding: 0px;background: {{ $loop->iteration % 2 == 0 ? '' : '#fff5f5' }};border:none">&nbsp;</td>
                ...
                {{-- <tr style=" margin-top:10px;height: 10px; background: {{ $i % 2 == 0 ? '' : '#fdf6e7' }} !important;">
                    <td colspan="4" class="col-2" style="padding: 0px;border:none">&nbsp;</td>
                    ...
                    <td class="col-2" style="padding: 0px;border:1px solid #4e4d4d;background:#c0c0c099">
                        <span style="float:left;margin-left:10px"></span>{{ $client->invoices->sum('amount') }} <span
                            style="float:right;margin-right:10px"></span>
                    </td>
                </tr> --}}
                ...
                <tr style="height: 10px; background: {{ $i % 2 == 0 ? '' : '#fdf6e7' }} !important;">
                    ...
                    <td class="col-2" style="padding: 0px;border:none;text-align:right"> <b>Total Paid</b></td>
                    <td class="col-2" style="padding: 0px;border:none;">&nbsp;</td>
                ...
                <tr style="height: 10px; background: {{ $i % 2 == 0 ? '' : '#fdf6e7' }} !important;">
                    <td colspan="4" class="col-2" style="padding: 0px;border:none">&nbsp;</td>
                    <td class="col-2" style="padding: 0px;border:none;">&nbsp;</td>
                    <td class="col-2" style="padding: 0px;border:none;text-align:right"> <b>Agreement</b></td>
                    <td class="col-2" style="padding: 0px;border:none;">&nbsp;</td>
                    <td class="col-2" style="padding: 0px;border:1px solid #4e4d4d;background:#e9e7e799;">
                        <span style="float:left;margin-left:10px">$</span> {{ @$client->agreement->total_amount }}<span
                            style="float:right;margin-right:10px">-</span>
                    </td>
                </tr>
                <tr style="height: 10px; background: {{ $i % 2 == 0 ? '' : '#fdf6e7' }} !important;">
                    <td colspan="4" class="col-2" style="padding: 0px;border:none">&nbsp;</td>
                    <td class="col-2" style="padding: 0px;border:none;">&nbsp;</td>
                    <td class="col-2" style="padding: 0px;border:none;text-align:right"> <b>Total Due</b></td>
                    <td class="col-2" style="padding: 0px;border:none;">&nbsp;</td>
                    <td class="col-2" style="padding: 0px;border:1px solid #4e4d4d;background:#e9e7e799;">
                        <span style="float:left;margin-left:10px">$</span> {{@$client->agreement->total_amount - $client->invoices->sum('amount') }}  <span
                            style="float:right;margin-right:10px">-</span>
                    </td>
                </tr>
            </tbody>
