                ...
                <div class="card-header">
                    <div class="row flex-between-center">
                        ...
                        <div class="col-8 col-sm-auto text-end ps-2">
                            ...
                            <div id="table-customers-replace-element"><a href="{{ route('lawyers.create') }}"
                        ...
                        <table class="table table-sm table-striped fs-10 mb-0 overflow-hidden">
                            <thead class="bg-200">
                                <tr>
                                    ...
                                    <th class="text-900 sort pe-1 align-middle white-space-nowrap" data-sort="phone">Case Type
                                    </th>
                                ...
                                @forelse ($lawyers as $info)
                                    <tr class="btn-reveal-trigger">
                                        ...
                                        <td class="joined align-middle py-2"> <span
                                                class="badge bg-{{ $info->isActive == 1 ? 'success' : 'success' }}">{{ $info->isActive == 1 ? 'Yes' : 'Yes' }}</span>
                                        </td>
                                            ...
                                            <div class="dropdown font-sans-serif position-static"><button
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end border py-0"
                                                    ...
                                                    <div class="py-2">
                                                        ...
                                                        @else
                                                        <a class="dropdown-item text-success"  href="{{ route('lawyers.edit', $info->id) }}">Edit</a>
                                                        @endif

                                                        {{-- <a class="dropdown-item text-warning"  href="{{ route('lawyers.change.password', $info->id) }}">Change Password</a> --}}
                                                        <a class="dropdown-item text-danger"
                                                        href="#"
                                                        onclick="confirmAction(event, '{{ route('record.delete', ['model' => 'Lawyer', 'id' => $info->id]) }}')">
                                                        Delete
                                                     </a>
                                                    </div>
                                                </div>
