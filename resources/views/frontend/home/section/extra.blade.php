<section class="bg-img cover-background secondary-overlay" data-overlay-dark="8" data-background="{{asset('v1')}}/img/bg-2.jpg">
    <div class="container">
        <div class="row align-items-center mt-n7">
            <div class="col-lg-8 mt-7 text-center text-lg-start">
                <div class="border-bottom border-color-light-white pb-1-9 pb-md-2-5 mb-1-6 mb-md-2-5">
                    ...
                    <p class="mb-0 w-95 text-white display-29 display-sm-28 opacity9 mx-auto mx-lg-0">Goals & Achievement of our Firm     At the Law Office of Pema Lhamu Bhutia, PC, our mission is to provide compassionate, strategic, and results-driven immigration legal services. We are committed to Advocating for Immigrants’ and Delivering Personalized Legal Solutions     We have achieved more than Thousands Approved Cases for our clients, Successful SIJS, Waivers & Appeals, preventing deportations and securing legal status for many clients.</p>
                </div>
